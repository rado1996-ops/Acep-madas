...
class Swift_Events_SimpleEventDispatcher implements \MailPoetVendor\Swift_Events_EventDispatcher
{
    ...
    private function _prepareBubbleQueue(\MailPoetVendor\Swift_Events_EventObject $evt)
    {
    ...
    private function _bubble(\MailPoetVendor\Swift_Events_EventObject $evt, $target)
    {
