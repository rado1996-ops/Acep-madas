...
class Swift_Message extends \MailPoetVendor\Swift_Mime_SimpleMessage
{
    ...
    {
        \call_user_func_array(array($this, 'MailPoetVendor\\Swift_Mime_SimpleMessage::__construct'), \MailPoetVendor\Swift_DependencyContainer::getInstance()->createDependenciesFor('mime.message'));
        if (!isset($charset)) {
    ...
    {
        return $this->attach(\MailPoetVendor\Swift_MimePart::newInstance($body, $contentType, $charset)->setEncoder($this->getEncoder()));
    }
    /**
