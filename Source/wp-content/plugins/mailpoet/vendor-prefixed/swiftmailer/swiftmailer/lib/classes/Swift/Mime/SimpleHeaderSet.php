 ...
 * @author Chris Corbyn
 */
class Swift_Mime_SimpleHeaderSet implements \MailPoetVendor\Swift_Mime_HeaderSet
{
    /** HeaderFactory */
    private $_factory;
     ...
     */
    public function __construct(\MailPoetVendor\Swift_Mime_HeaderFactory $factory, $charset = null)
    {
    ...
    private function _storeHeader($name, \MailPoetVendor\Swift_Mime_Header $header, $offset = null)
    {
    ...
    private function _isDisplayed(\MailPoetVendor\Swift_Mime_Header $header)
    {
