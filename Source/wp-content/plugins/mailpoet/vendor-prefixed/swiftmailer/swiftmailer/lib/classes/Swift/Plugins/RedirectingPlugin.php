...
class Swift_Plugins_RedirectingPlugin implements \MailPoetVendor\Swift_Events_SendListener
{
     ...
     * @param string               $type
     */
    private function _filterHeaderSet(\MailPoetVendor\Swift_Mime_HeaderSet $headerSet, $type)
    {
    ...
    private function _restoreMessage(\MailPoetVendor\Swift_Mime_Message $message)
    {
