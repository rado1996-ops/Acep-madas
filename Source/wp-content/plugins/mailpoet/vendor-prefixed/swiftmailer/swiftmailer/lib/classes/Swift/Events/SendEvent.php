 ...
 * @author Chris Corbyn
 */
class Swift_Events_SendEvent extends \MailPoetVendor\Swift_Events_EventObject
{
     ...
     */
    public function __construct(\MailPoetVendor\Swift_Transport $source, \MailPoetVendor\Swift_Mime_Message $message)
    {
