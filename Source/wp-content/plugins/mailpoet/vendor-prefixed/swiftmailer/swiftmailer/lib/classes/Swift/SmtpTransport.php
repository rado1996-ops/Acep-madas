...
class Swift_SmtpTransport extends \MailPoetVendor\Swift_Transport_EsmtpTransport
{
    ...
    {
        \call_user_func_array(array($this, 'MailPoetVendor\\Swift_Transport_EsmtpTransport::__construct'), \MailPoetVendor\Swift_DependencyContainer::getInstance()->createDependenciesFor('transport.smtp'));
        $this->setHost($host);
        $this->setPort($port);
