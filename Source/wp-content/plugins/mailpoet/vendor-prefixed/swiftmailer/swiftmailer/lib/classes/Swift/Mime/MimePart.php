...
class Swift_Mime_MimePart extends \MailPoetVendor\Swift_Mime_SimpleMimeEntity
{
    ...
    {
        return 'yes' == $this->_getHeaderParameter('Content-Type', 'delsp') ? \true : \false;
    }
    /**
    ...
    protected function _convertString($string)
    {
        ...
        if (!\in_array($charset, array('utf-8', 'iso-8859-1', 'iso-8859-15', ''))) {
            ...
            if (\function_exists('mb_convert_encoding')) {
                ...
                throw new \MailPoetVendor\Swift_SwiftException('No suitable convert encoding function (use UTF-8 as your charset or install the mbstring or iconv extension).');
            }
            return $string;
        }
        return $string;
