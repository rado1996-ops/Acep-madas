 ...
 * @author Chris Corbyn
 */
class Swift_Mime_SimpleMessage extends \MailPoetVendor\Swift_Mime_MimePart implements \MailPoetVendor\Swift_Mime_Message
{
     ...
     */
    public function __construct(\MailPoetVendor\Swift_Mime_HeaderSet $headers, \MailPoetVendor\Swift_Mime_ContentEncoder $encoder, \MailPoetVendor\Swift_KeyCache $cache, \MailPoetVendor\Swift_Mime_Grammar $grammar, $charset = null)
    {
     ...
     * @return $this
     */
    public function attach(\MailPoetVendor\Swift_Mime_MimeEntity $entity)
    {
     ...
     * @return $this
     */
    public function detach(\MailPoetVendor\Swift_Mime_MimeEntity $entity)
    {
        $newChildren = array();
     ...
     * @return string
     */
    public function embed(\MailPoetVendor\Swift_Mime_MimeEntity $entity)
    {
        $this->attach($entity);
