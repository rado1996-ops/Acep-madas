...
class Translator extends \MailPoetVendor\Symfony\Component\Translation\Translator
{
    /**
    ...
    public function __construct($locale, \MailPoetVendor\Symfony\Component\Translation\Formatter\MessageFormatterInterface $formatter = null, $cacheDir = null, $debug = \false)
    {
        $this->addLoader('array', new \MailPoetVendor\Symfony\Component\Translation\Loader\ArrayLoader());
