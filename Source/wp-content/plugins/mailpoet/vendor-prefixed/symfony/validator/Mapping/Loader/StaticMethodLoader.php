 ...
 */
class StaticMethodLoader implements \MailPoetVendor\Symfony\Component\Validator\Mapping\Loader\LoaderInterface
{
    ...
    public function loadClassMetadata(\MailPoetVendor\Symfony\Component\Validator\Mapping\ClassMetadata $metadata)
    {
        ...
        if (!$reflClass->isInterface() && $reflClass->hasMethod($this->methodName)) {
            ...
            if (!$reflMethod->isStatic()) {
                throw new \MailPoetVendor\Symfony\Component\Validator\Exception\MappingException(\sprintf('The method %s::%s should be static', $reflClass->name, $this->methodName));
            }
